...
| 本地回归 | `C:\Users\Ding\miniforge3\python.exe -m pytest tests\test_tools.py tests\test_setup.py tests\test_plugin_registration.py tests\test_trace.py tests\test_verify_wsl_feishu_runtime.py -q` 返回 `170 passed` |
