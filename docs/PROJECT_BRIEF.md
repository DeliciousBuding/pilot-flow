...
- pending platform edges are explicit, especially repeated `pilot:run` live parity, real card callback delivery, automatic IM trigger, and announcement fallback behavior
