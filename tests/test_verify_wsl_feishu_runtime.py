...
def test_verify_runtime_project_creation_is_sanitized(tmp_path, monkeypatch):
    ...
    assert result["project_create_detail_calendar_reminder_shown"] is True
    ...
    assert result["project_create_entry_card_failure_displayed"] is True
...
def test_verify_runtime_deadline_update_is_sanitized(tmp_path, monkeypatch):
    ...
    assert result["deadline_state_updated"] is True
    assert result["deadline_state_hooks_ran"] is True
    assert result["deadline_state_feedback_sent"] is True
...
def test_verify_runtime_risk_cycle_is_sanitized(tmp_path, monkeypatch):
    ...
    assert result["risk_state_card_resolved"] is True
    assert result["risk_state_card_recorded"] is True
    assert result["risk_state_card_feedback_sent"] is True
...
def test_verify_runtime_progress_update_is_sanitized(tmp_path, monkeypatch):
    ...
    assert result["progress_state_assignees_preserved"] is True
...
def test_verify_runtime_projectization_suggestion_is_sanitized(tmp_path, monkeypatch):
    ...
    assert result["projectization_clarification_no_card"] is True
    assert result["projectization_clarification_no_pending"] is True
    assert result["projectization_clarification_no_gate"] is True
    assert result["projectization_clarification_followup_plan_sent"] is True
    assert result["projectization_clarification_followup_pending"] is True
    assert result["projectization_clarification_followup_gate"] is True
    assert result["projectization_clarification_confirm_created"] is True
    ...
    assert result["projectization_confirm_retryable_failure"] is True
...
def test_verify_runtime_card_status_cycle_is_sanitized(tmp_path, monkeypatch):
    ...
    assert result["card_status_origin_feedback_sync_summary"] is True
...
def test_verify_runtime_batch_followup_task_is_sanitized(tmp_path, monkeypatch):
    ...
    assert result["batch_followup_state_assignee_filtered"] is True
    assert result["batch_followup_feedback_sent"] is True
    assert result["batch_followup_origin_feedback_projects_named"] is True
...
def test_verify_runtime_dashboard_navigation_is_sanitized(tmp_path, monkeypatch):
    ...
    assert result["dashboard_no_implicit_briefing"] is True
    assert result["dashboard_explicit_briefing"] is True
    assert "example.invalid" not in json.dumps(result, ensure_ascii=False)
...
def test_verifier_project_creation_mode_outputs_sanitized_runtime_result(tmp_path, capsys):
    ...
    with patch.object(_MODULE, "_verify_runtime_project_creation", return_value={
        ...
        "project_create_detail_calendar_reminder_shown": True,
        ...
        "project_create_entry_card_failure_displayed": True,
    ...
    assert output["project_create_detail_calendar_reminder_shown"] is True
    ...
    assert output["project_create_entry_card_failure_displayed"] is True
...
def test_verifier_deadline_update_mode_outputs_sanitized_runtime_result(tmp_path, capsys):
    ...
    with patch.object(_MODULE, "_verify_runtime_deadline_update", return_value={
        ...
        "deadline_state_updated": True,
        "deadline_state_hooks_ran": True,
        "deadline_state_feedback_sent": True,
    ...
    assert output["deadline_state_updated"] is True
    assert output["deadline_state_hooks_ran"] is True
    assert output["deadline_state_feedback_sent"] is True
...
def test_verifier_risk_cycle_mode_outputs_sanitized_runtime_result(tmp_path, capsys):
    ...
    with patch.object(_MODULE, "_verify_runtime_risk_cycle", return_value={
        ...
        "risk_state_card_resolved": True,
        "risk_state_card_recorded": True,
        "risk_state_card_feedback_sent": True,
    ...
    assert output["risk_state_card_resolved"] is True
    assert output["risk_state_card_recorded"] is True
    assert output["risk_state_card_feedback_sent"] is True
...
def test_verifier_progress_update_mode_outputs_sanitized_runtime_result(tmp_path, capsys):
    ...
    with patch.object(_MODULE, "_verify_runtime_progress_update", return_value={
        ...
        "progress_state_initiator_preserved": True,
        "progress_state_assignees_preserved": True,
    ...
    assert output["progress_state_initiator_preserved"] is True
    assert output["progress_state_assignees_preserved"] is True
...
def test_verifier_projectization_suggestion_mode_outputs_sanitized_runtime_result(tmp_path, capsys):
    ...
    with patch.object(_MODULE, "_verify_runtime_projectization_suggestion", return_value={
        ...
        "projectization_clarification_no_card": True,
        "projectization_clarification_no_pending": True,
        "projectization_clarification_no_gate": True,
        "projectization_clarification_followup_plan_sent": True,
        "projectization_clarification_followup_pending": True,
        "projectization_clarification_followup_gate": True,
        "projectization_clarification_confirm_created": True,
        ...
        "projectization_confirm_retryable_failure": True,
    ...
    assert output["projectization_clarification_no_card"] is True
    assert output["projectization_clarification_no_pending"] is True
    assert output["projectization_clarification_no_gate"] is True
    assert output["projectization_clarification_followup_plan_sent"] is True
    assert output["projectization_clarification_followup_pending"] is True
    assert output["projectization_clarification_followup_gate"] is True
    assert output["projectization_clarification_confirm_created"] is True
    ...
    assert output["projectization_confirm_retryable_failure"] is True
...
def test_verifier_card_status_cycle_mode_outputs_sanitized_runtime_result(tmp_path, capsys):
    ...
    with patch.object(_MODULE, "_verify_runtime_card_status_cycle", return_value={
        ...
        "card_status_origin_feedback_sync_summary": True,
    ...
    assert output["card_status_origin_feedback_sync_summary"] is True
...
def test_verifier_batch_followup_task_mode_outputs_sanitized_runtime_result(tmp_path, capsys):
    ...
    with patch.object(_MODULE, "_verify_runtime_batch_followup_task", return_value={
        ...
        "batch_followup_state_assignee_filtered": True,
        "batch_followup_feedback_sent": True,
        "batch_followup_origin_feedback_projects_named": True,
    ...
    assert output["batch_followup_state_assignee_filtered"] is True
    assert output["batch_followup_feedback_sent"] is True
    assert output["batch_followup_origin_feedback_projects_named"] is True
...
def test_verifier_dashboard_navigation_mode_outputs_sanitized_runtime_result(tmp_path, capsys):
    ...
    with patch.object(_MODULE, "_verify_runtime_dashboard_navigation", return_value={
        ...
        "dashboard_no_implicit_briefing": True,
        "dashboard_explicit_briefing": True,
        "raw_chat_id": "oc_real_chat_id",
        "raw_doc_url": "https://example.invalid/doc/1",
    }):
        exit_code = _MODULE.main([
    ...
    assert output["dashboard_no_implicit_briefing"] is True
    assert output["dashboard_explicit_briefing"] is True
    assert "oc_real_chat_id" not in output_text
    assert "example.invalid" not in output_text
