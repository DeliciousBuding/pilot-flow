...
function parseArgs(argv) {
  ...
  return {
    ...
    runLog: resolve(typeof args["run-log"] === "string" ? args["run-log"] : "tmp/runs/announcement-upgrade-live-20260429-fixed.jsonl"),
    flightRecorder: resolve(typeof args["flight-recorder"] === "string" ? args["flight-recorder"] : "tmp/flight-recorder/announcement-upgrade-live-20260429-fixed.html"),
    evidence: resolve(typeof args.evidence === "string" ? args.evidence : "tmp/demo-evidence/DEMO_EVIDENCE_20260429.md"),
    evaluation: resolve(typeof args.evaluation === "string" ? args.evaluation : "tmp/demo-eval/DEMO_EVAL_20260429.md"),
