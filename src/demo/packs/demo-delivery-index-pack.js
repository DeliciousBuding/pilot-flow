...
const DEFAULT_SOURCES = [
  ...
  },
  {
    ...
    anchor: "PilotFlow",
    required: true,
    purpose: "Reviewer-facing answers and boundary language."
  },
  {
    key: "submissionGuide",
    group: "public_docs",
    ...
    anchor: "Demo Submission Pack",
    required: true,
    purpose: "Final local submission gate workflow."
  },
  {
    key: "readiness",
...
function buildNextActions({ status, submissionStatus, callbackStatus }) {
  if (status === "needs_regeneration") {
    return [
      ...
      "Rerun the delivery index after readiness, judge, submission, and callback packs are current."
    ];
  }
...
Options:
  ...
  --submission-guide <path>   Submission guide path.
