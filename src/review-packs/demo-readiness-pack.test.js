...
try {
  ...
  const docOverrides = {
    ...
    "Failure paths": await writeDoc(docsDir, "failure-paths.md", "Fallback map"),
    "Capture guide": await writeDoc(docsDir, "capture-guide.md", "Required Captures"),
    "Demo kit index": await writeDoc(docsDir, "README.md", "Review packs")
  };
  ...
  assert.equal(pack.summary.docsReady, 4);
