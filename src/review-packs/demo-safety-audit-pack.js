...
const DEFAULT_SCAN_TARGETS = [
  ...
  },
  {
    ...
    path: "tmp/demo-delivery/DELIVERY_INDEX.md",
    kind: "file",
    group: "generated_review_material",
    required: false
  },
...
function buildNextActions({ status, findings, missingRequired }) {
  ...
  if (findings.length > 0) {
    return [
      ...
      "Rerun `npm run review:safety-audit` and keep the clean report with the submission materials."
    ];
  }
