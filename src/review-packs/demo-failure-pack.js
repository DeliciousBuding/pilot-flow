...
export async function buildDemoFailurePack({
  ...
  liveRunLog = "tmp/runs/latest-live-run.jsonl",
  evalPack = "tmp/demo-eval/DEMO_EVAL.md",
...
function parseArgs(argv) {
  ...
  return {
    ...
    liveRunLog: resolve(typeof args["live-run-log"] === "string" ? args["live-run-log"] : "tmp/runs/latest-live-run.jsonl"),
    evalPack: resolve(typeof args["eval-pack"] === "string" ? args["eval-pack"] : "tmp/demo-eval/DEMO_EVAL.md"),
