...
PilotFlow 是一个面向飞书协作场景的 **AI 项目运行官**：

> **像一个项目经理一样，在飞书群里推动团队从讨论走向交付。**

在真实协作中，项目的关键信息散落在群聊各处——目标、负责人、截止时间、风险、材料、确认意见。PilotFlow 让 AI Agent 承担主驾驶角色：理解讨论内容，生成项目执行计划，请求人类确认，调用飞书原生工具执行，并将结果沉淀到文档、多维表格、任务、群入口消息和交付总结中。

产品体验发生在团队日常工作的飞书环境中：**IM 群聊、互动卡片、文档、多维表格、任务系统**。

> **Agent 主驾驶，GUI 做仪表盘，人类始终掌舵。**

## 核心能力

PilotFlow 从群聊中的一句话项目需求出发，完成以下闭环：
